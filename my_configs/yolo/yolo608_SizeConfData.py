# Изменены размеры якорных боксов и порог confidence на 0.3. Таже поменян тип датасета -> игнорируем боксы, площадь которых менее 10
...
workflow = [('train', 1)]
work_dir = './experiment/yolo/yolo608_SizeConfData_ignore'
model = dict(
    type='YOLOV3',
