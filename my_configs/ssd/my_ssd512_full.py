...
data = dict(
    ...
    train=dict(
            type=dataset_type,
            ann_file= TRAIN_FILES, # data_root + 'ch02_20200605121548-part 00000.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file= VAL_FILES, #data_root + 'ch01_20200605121410-part 00000.json',
        img_prefix=data_root,
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=TEST_FILES, #data_root + 'ch02_20200605114152-part 00000.json',
        img_prefix=data_root,
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
